				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="salary.php">Salary Staff</a></li>
							<li><a href="pad.php">Praise and Discipline</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						<span class="micon dw dw-edit-2"></span><span class="mtext">Timekeeping</span>
						</a>
						<ul class="submenu">
							<li><a href="timekeping.php">Today</a></li>
							<li><a href="historytime.php">History Timekeeping</a></li>
						</ul>
					</li>
