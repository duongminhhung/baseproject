...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,salary,Status, location, Staff_ID, Position_Staff) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$leave_days','$user_role','$phonenumber','$salary','$status', 'NO-IMAGE-AVAILABLE.jpg','$staff_id','$position_staff')         
		") or die(mysqli_error()); ?>
							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Salary :</label>
											<input name="leave_days" type="number" class="form-control" required="true" autocomplete="off" name="salary">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
