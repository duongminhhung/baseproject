...
<?php
	...
	$result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', Av_leave='$leave_days', role='$user_role', Phonenumber='$phonenumber',salary='$salary', Position_Staff='$position_staff', Staff_ID='$staff_id' where emp_id='$get_id'         
		"); 		
	if ($result) {
							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Salary :</label>
											<input name="salary" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['salary'];  ?>">
										</div>
									</div>
