			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						$today = date("Y-m-d");
						$sql = "SELECT * from timekepping where ts >= '8:00:00' and date = '$today'";
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo ($row); ?></div>
								<div class="font-14 text-secondary weight-500">Employee Late Today</div>
							</div>
							<div class="widget-icon">
